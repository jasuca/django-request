...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('request_request', 'time', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Request.time'
        db.alter_column('request_request', 'time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
