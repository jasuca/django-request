...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.session_key'
        db.add_column('request_request', 'session_key',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.session_key'
        db.delete_column('request_request', 'session_key')
